...
if __name__ == "__main__":
    ...
    best_solution_with_elitism, best_fitness_per_generation_with_elitism = genetic_algorithm(population_size, num_strings, string_length, generations)
    ...
    _, best_fitness_per_generation_without_elitism = genetic_algorithm(population_size, num_strings, string_length, generations)
